...
class MainScreen(Screen):
    ...
    def compose(self) -> ComposeResult:
        yield TestCodeStatusBar(id="status-bar")
        with Horizontal():
    ...
    async def on_mount(self) -> None:
        ...
        self.query_one(TestCodeStatusBar).model_name = self.llm.default_model
        self.query_one(TestCodeStatusBar).session_count = len(sessions)
